...
INSERT INTO `oauth_users` (`id`, `username`, `password`, `scope`, `createdAt`, `updatedAt`) VALUES
  ...
  (2, 'user@user', '$2a$10$HuAzaQ1xLtsAzJz6snzQluButYKezbb2jELgOYwr/OHwsoFXsccz2', 'read', '2017-04-22 18:36:40', '2017-04-22 18:36:40');
...
INSERT INTO `oauth_clients` (`id`, `name`, `clientId`, `clientSecret`, `grants`, `refreshTokenLifetime`, `accessTokenLifetime`, `scope`, `userId`, `createdAt`, `updatedAt`) VALUES
	(1, 'demoName', 'demo', 'demosecret', 'authorization_code password refresh_token client_credentials', NULL, NULL, 'read write', 1, '2017-04-22 18:36:40', '2017-04-22 18:36:40'),
